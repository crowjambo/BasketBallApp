...
class TeamsDatabase{
	...
	class func LoadFakeData() -> [TeamInfo]{
		...
		let someTeam:TeamInfo = TeamInfo(teamName: "Toronto Raptors2", description: "Pretty good team", imageIconName: "pencil.circle.fill", imageTeamMain: "toronto")
		...
		if let teamName = someTeam.teamName{
			someTeam.matchHistory.append(MatchHistory(team1Name: teamName, team2Name: "Salininku Maxima", date: "Jan 1"))
			someTeam.matchHistory.append(MatchHistory(team1Name: teamName, team2Name: "Sasdasd", date: "Jan 2"))
			someTeam.matchHistory.append(MatchHistory(team1Name: teamName, team2Name: "cccc", date: "Jan 3"))
		}
